...
for index, row in df.iterrows():
    image_eye_path = '/home/cvlab/Desktop/prakriti/face_masking-main/res/test_res/' + row['AppID'] +'/skin_colors.txt'
...
cnn_model.fit(X_train_scaled, y_train, epochs=10, batch_size=10, validation_data=(X_val_scaled, y_val))
...
for i in range(10):
    ...
    predicted_label = predict_with_cnn_model
