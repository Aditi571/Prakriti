...
dataset = []
target_length = 2187  # Desired length of RGB arrays
...
X_train_scaled = X_train_scaled.reshape(X_train_scaled.shape[0], 81,81, 1)
X_val_scaled = X_val_scaled.reshape(X_val_scaled.shape[0], 81,81, 1)
...
cnn_model.fit(X_train_scaled, y_train, epochs=50, batch_size=10, validation_data=(X_val_scaled, y_val))
